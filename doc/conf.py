...
htmlhelp_basename = 'dsklayoutdoc'
...
latex_documents = [
    (master_doc, 'dsklayout.tex', 'dsklayout Documentation',
...
texinfo_documents = [
    (master_doc, 'dsklayout', 'dsklayout Documentation',
     author, 'dsklayout', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {'https://docs.python.org/': None,
                       'https://setuptools.readthedocs.io/en/latest': None}
